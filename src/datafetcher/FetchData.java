...
public class FetchData implements Runnable {
	 ...
	 * 
	 * @param fileUrl
	 *            url of text file to download( http url from html)
	 * @param fileName
	 *            name of file
	 */
	...
	/**
	 * This method is used to read file from server. WE are reading file from server
	 * and storing to our end
	 * 
	 * @param fileUrl
	 * @param fileName
	 */
	public void downloadFile(String fileUrl, String fileName) {
		...
		try {
			...
			/**
			 * normally, 3xx is redirect This logic is because when i was clicking on Href
			 * http url found in
			 * <td>tag it is redirecting to https url
			 */
